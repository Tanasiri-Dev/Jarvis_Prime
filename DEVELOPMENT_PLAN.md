...
- SPC quick helper. (Implemented in Phase 0 tool library prototype)
- Alarm code decoder.
- Log parser.
- Recipe compare.
...
1. Meeting room calendar mockup with Phuket, Pattaya, Singha, and Chang.
2. CSV and log quick parser after sample logs are available.
